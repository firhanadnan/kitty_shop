					...
					<table>
						...
						<tr>
		                    ...
		                    <td>     	
		                    	<input type="text" name="harpok" id="harga_beli" style="width:80px;margin-right:5px;" class="form-control input-sm" readonly>
		                    </td>
		                    <td>   	
		                    	<input type="text" name="harjul" id="harga_jual" style="width:80px;margin-right:5px;" class="form-control input-sm" readonly>
		                    </td>
					...
					<script>
						$(document).ready(function(){ // Ketika halaman sudah siap (sudah selesai di load)
							...
							$("#ukuran").change(function(){ // Ketika user mengganti atau memilih data provinsi
								...
								$.ajax({
									...
									url: "<?php echo base_url("Pembelian/get_warna"); ?>", // Isi dengan url/path file php yang dituju
						...
						$(document).ready(function(){ 							
							$("#warna").change(function(){ // Ketika user mengganti atau memilih data provinsi
								...
								$.ajax({
									type: "POST", // Method pengiriman data bisa dengan GET atau POST
									url: "<?php echo base_url("Pembelian/get_qty"); ?>", // Isi dengan url/path file php yang dituju
									data: { ukuran : $("#ukuran").val(),
											warna : $("#warna").val(),
											kode_brg : $("#kode_brg").val()
									}, // data yang akan dikirim ke file yang dituju
