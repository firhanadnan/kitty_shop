                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Jenis</h4>
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">
                                            <button onclick="add_type()" class="btn btn-primary waves-effect waves-light mb-2">
                                                <i class="bx bx-plus font-size-12 align-middle mr-2"></i> Add Jenis
                                            </button>
                                        </h4>        
                                ...
                                <div class="modal-body form">
                                    <form class="custom-validation" action="#" id="form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kode_satuan" class="form-control" placeholder="Kode Jenis"/>
                                            <span class="invalid-feedback"></span>
                                        </div>  
                                        <div class="form-group">
                                            <label>Nama Jenis</label>
                                            <input type="text" name="nama_satuan" class="form-control" placeholder="Nama Jenis"/>
                                            <span class="invalid-feedback"></span>
                                        </div>                                             
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      return {
        ...
        serverSide: true,
        ajax: {
                  "url": "<?= base_url().'satuan/satuan_json'?>",
                  "type": "POST"
              },
        columns: [
                  {
